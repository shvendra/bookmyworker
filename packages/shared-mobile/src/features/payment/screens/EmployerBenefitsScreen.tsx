...
const s = StyleSheet.create({
  ...
  heroLabel:   { color: 'rgba(255,255,255,0.65)', fontSize: 11, fontWeight: '700', letterSpacing: 0.6, textTransform: 'uppercase', marginBottom: 4 },
  heroTitle:   { color: WHITE, fontSize: 23, fontWeight: '900', letterSpacing: -0.4, marginBottom: 3 },
  heroTagline: { color: 'rgba(255,255,255,0.6)', fontSize: 12, marginBottom: 10 },
