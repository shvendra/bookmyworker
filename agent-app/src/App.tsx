...
// Tags every outgoing request as coming from the agent app, so the backend
// can tell it apart from the employer app (both share this API client).
setClientPlatform('agent_app');
